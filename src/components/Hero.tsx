  ...
  const reviews = [
    {
      ...
      rating: 5,
      comment: "Sahay transformed the campus experience! The features are incredibly useful and everything is managed very structurally",
    ...
    },
    {
      ...
      name: "Dev Chhabada",
      rating: 4,
      comment: "Great platform for connecting with other students. Very intuitive interface.",
      avatar: "/api/placeholder/32/32"
    },
    {
      id: 3,
      name: "Yash Bhojwani",
      rating: 5,
      comment: "The best campus companion app I've ever used. Highly recommended!",
      avatar: "/api/placeholder/32/32"
    },
    {
      id: 3,
      name: "Anirudh Gote",
      rating: 5,
      comment: "The best campus app I've ever used for teams and events. I Highly recommended!",
      avatar: "/api/placeholder/32/32"
    },
    {
      id: 3,
      ...
      rating: 5,
      comment: "The best app for connecting with students. Being teacher connecting with skilled students for projects is very helpful. I Highly recommended!",
      avatar: "/api/placeholder/32/32"
    }
  ];
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          >
            ...
            >
              ...
              <span className="text-sm font-medium">Experience the Future of Campus Life</span>
            </motion.div>
            ...
            >
              Your Campus Journey Starts with Sahay
            </motion.h1>
            ...
            >
              Connect, learn, and thrive with cutting-edge features designed for the next 
              generation of campus life. Experience a seamless blend of community, 
